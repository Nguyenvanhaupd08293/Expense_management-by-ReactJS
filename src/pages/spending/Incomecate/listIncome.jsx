...
import { FetchIncomeList, RemoveIncome } from "../../../redux/action/Income";
                        ...
                        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" className="p-4">Khoản thu nhập</th>
                                    <th scope="col" className="p-4">Tiền thu nhập</th>
                                    <th scope="col" className="p-4">Hình thức nhận</th>
                                    <th scope="col" className="p-4">Ngày nhận</th>
                                    <th scope="col" className="p-4"></th>
                                </tr>
                            </thead>
                            <tbody>
                                {props.income.incomelist &&
                                    props.income.incomelist.map((item) => (
...
const mapDispatchToProps = (dispatch) => {
    return {
        loadspend: () => dispatch(FetchIncomeList()),
        removespend: (id) => dispatch(RemoveIncome(id)),
    };
};
