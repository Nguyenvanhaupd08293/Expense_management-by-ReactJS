...
import { FunctionAddIncome } from '../../../redux/action/Income';
const IncomeCate = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(FunctionAddIncome(userObj));
...
export default connect(mapStateToProps, mapDispatchToProps)(IncomeCate);
